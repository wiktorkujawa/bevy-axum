...
pub(crate) fn spawning_plugin(app: &mut App) {
    app.add_plugins(SpewPlugin::<GameObject, SpawnStruct>::default())
        ...
        .add_spawners((
            ...
            (GameObject::Object, objects::object::spawn),
            (GameObject::Player, objects::player::spawn),
            (GameObject::Dialog, objects::dialog::spawn),
