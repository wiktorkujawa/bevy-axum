...
pub(crate) struct CharacterControllerBundle {
    ...
    // pub(crate) autostep: KinematicCharacterController,
...
impl Default for CharacterControllerBundle {
    fn default() -> Self {
        Self {
            read_mass: default(),
            // autostep: KinematicCharacterController {
            //     autostep: Some(CharacterAutostep {
            //         max_height: CharacterLength::Relative(0.7),
...
pub(crate) struct CharacterAnimations {
    ...
    pub(crate) running: Handle<AnimationClip>,
