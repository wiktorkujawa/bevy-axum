...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he789dd90ddf0af69: (a: number, b: number) => void;
  readonly closure17232_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2ee2a429a174c93b: (a: number, b: number) => void;
  readonly closure17489_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h03267cf04baebadc: (a: number, b: number) => void;
  readonly closure72054_externref_shim: (a: number, b: number, c: any) => void;
